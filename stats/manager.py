...
class StatsEnv:
    def __init__(self,
        ...
        interval = list(zip(*stats.t.interval(1 - t, n - p, coef, coef_stderrs)))
        ...
        self.stats_result = dict(
            ...
            SSE=SSE,
            R2=R2,
            interval=pd.DataFrame([data.columns[1:], interval]).T,
...
s = StatsEnv(df, target='SalePrice', t=0.025).to_standard
print(s)
# s.plot([1, 2, 3])
# print(s.to_standard)
